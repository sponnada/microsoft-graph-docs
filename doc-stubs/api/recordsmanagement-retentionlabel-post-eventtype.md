---
title: "Add retentionEventType"
description: "Add eventType by posting to the eventType collection."
...
# Add retentionEventType
Namespace: microsoft.graph.recordsManagement

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Add eventType by posting to the eventType collection.
...
-->
``` http
POST /compliance/recordsManagement/labels/{retentionLabelId}/eventType/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [retentionEventType](../resources/recordsmanagement-retentioneventtype.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/compliance/recordsManagement/labels/{retentionLabelId}/eventType/$ref
